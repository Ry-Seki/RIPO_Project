...
namespace {
	constexpr const char* _DUNGEON01_BGMPATH = "Res/Audio/BGM/Dungeon/Dungeon_1/星の詩.mp3";					// ダンジョン1のBGMパス
	constexpr const char* _DUNGEON02_BGMPATH = "Res/Audio/BGM/Dungeon/Dungeon_2/Apparition’s_Lullaby.mp3";	// ダンジョン2のBGMパス
	constexpr const char* _DUNGEON03_BGMPATH = "Res/Audio/BGM/Dungeon/Dungeon_3/Soldiers.mp3";	// ダンジョン3のBGMパス
	constexpr const char* _DUNGEON04_BGMPATH = "Res/Audio/BGM/Dungeon/Dungeon_4/六つの鐘が鳴る頃に.mp3";	// ダンジョン4のBGMパス
	constexpr const char* _DUNGEONSELECT_BGMPATH = "Res/Audio/BGM/Dungeon/DungeonSelectBGM.mp3";				// ダンジョン選択画面のBGMパス
}
 /*
  *	@brief	初期化処理
  */
void InAction_Dungeon::Initialize(Engine& engine) {
	...
	auto dungeonBGM03 = LoadManager::GetInstance().LoadResource<LoadAudio>(_DUNGEON03_BGMPATH);
	auto dungeonBGM04 = LoadManager::GetInstance().LoadResource<LoadAudio>(_DUNGEON04_BGMPATH);
	auto selectDungeonBGM = LoadManager::GetInstance().LoadResource<LoadAudio>(_DUNGEONSELECT_BGMPATH);
	LoadManager::GetInstance().SetOnComplete([&engine, this, dungeonBGM01, dungeonBGM02,dungeonBGM03,dungeonBGM04, selectDungeonBGM]() {
		...
		AudioUtility::RegisterBGMHandle(GameConst::_DUNGEON_BGM03, dungeonBGM03->GetHandle());
		AudioUtility::RegisterBGMHandle(GameConst::_DUNGEON_BGM04, dungeonBGM04->GetHandle());
