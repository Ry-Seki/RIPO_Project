...
public:
	 ...
	 *  @return		StageBase*
	 */
	static StageBase* GetPrevStage() { 
		return StageManager::GetInstance().GetPrevStage(); 
	}
	/*
	 *	ステージのFrameを取得
	 ...
	 *  @return		int
	 */
	static int GetStageFrame(const std::string& frameName) { 
		return StageManager::GetInstance().GetStageFrame(frameName); 
	}
...
public:
	 ...
	 */
	static std::vector<Vector3> GetEnemySpwanPos() {
	 ...
	 *  @return		std::vector<Vector3>
	 */
	static std::vector<Vector3> GetTreasureSpwanPos() { 
	 ...
	 *  @return		std::vector<Vector3>
	 */
	static std::vector<Vector3> GetPointLightPos() { 
...
public:
	 ...
	 */
	static void SetStageJSONData(JSON setJSON) {
